...
spec = do
  ...
  it "type of type" $ match [person -: x] ~= "match person isa $x;"
  it "reify a relation" $ match [x <: [y, z]] ~= "match $x ($y, $z);"
  it "match just a variable" $ match [x] ~= "match $x;"
